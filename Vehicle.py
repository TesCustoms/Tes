...
class Vehicle:
    ...
    def __init__(self, make=GC.TESLA, model=GC.MODEL_S, year=2019, color=GC.WHITE, vin="TODO", gearShiftVelocity=[0, 15, 30, 50, 75]):
        """ TODO
        ...
        self.currentRPM = 0
        self.gearShiftVelocity = gearShiftVelocity
        ...
        if(make == GC.TESLA):
            # Add additional gear shift ranges to match number of gear simulated
            if(len(gearShiftVelocity) != GC.TOP_GEAR):
